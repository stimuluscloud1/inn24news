            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2>Reporter List</h2>    
                            <a href="<?php echo $base_url;?>user/add-reporter.php"><button type="button" class="btn btn-primary" style="float: right;"><i class="fa  fa-plus-square-o"></i> Add New Reporter</button></a>                        
                        </div></br>
                        <div class="body">
